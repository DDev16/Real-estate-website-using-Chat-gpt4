...
function LandingPage(props) {
  ...
  const apiKey = 'AIzaSyA_xD8_7EL76F4-Me_0HJ3dDd0Te4_hNE8';
  const center = { lat: 34.474876, lng: -114.34321 }; // Change these coordinates to the desired location
  const zoom = 13;

  return (
    <Container>
      <h1 className="text-center my-5 main-heading">Welcome to where your dreams come true.</h1>
      <Row>
...
<Col>
        ...
        <GoogleMap apiKey={apiKey} center={center} zoom={zoom} />
      </Col>
<Col md={6}>
